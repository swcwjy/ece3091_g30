...
{
  servo2.slowmove(76-75+90,10);
  servo3.slowmove(52+25,10);
  delay(300);
}
void panning_height_middle()
{
  servo2.slowmove(68-75+90,10);
...
{
  servo2.slowmove(62-75+90,10);
  servo3.slowmove(14+25,10);
  delay(300);
}
...
void colour_sensor_pos()
{
  ...
  servo1.slowmove(20,10)
  servo2.slowmove(17-75+90,10);
  servo3.slowmove(0+25,10);
  delay(300);
